...
public class RegisterTraderViewPager extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trader_register_viewpager);


        ////Action Bar
        ActionBar actionBar = getSupportActionBar();
        getSupportActionBar().setTitle(R.string.trader_reg);
       // String title = actionBar.getTitle().toString();




        mTabLayout = (TabLayout) findViewById(R.id.nav_traders_tabs);
        ...
        viewPager = (ViewPager) findViewById(R.id.register_trader_viewpager);
...
viewPager.setOnTouchListener(new View.OnTouchListener() {
    ...
    private class ScreenSlidePageAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new TraderDemoFragment();
                case 1:
                    return new TraderRegionFragment();

                case 2:
                    return new ReviewTraderData();
