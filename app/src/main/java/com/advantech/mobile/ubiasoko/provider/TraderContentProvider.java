...
import com.advantech.mobile.ubiasoko.view.ReviewTraderData;
...
public class TraderContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.advantech.mobile.ubiasoko.provider.TraderContentProvider";
