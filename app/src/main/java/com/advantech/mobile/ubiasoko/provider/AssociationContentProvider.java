...
import com.advantech.mobile.ubiasoko.view.ReviewAssociationData;
...
public class AssociationContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.advantech.mobile.ubiasoko.provider.AssociationContentProvider";
